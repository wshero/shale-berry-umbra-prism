...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bijv8RCu.js
var router_Bijv8RCu_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-_4MWckmS.css";
var APP_NAME = "导水裂隙带预测";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "矿区导水裂隙带三维预测工作台演示：地层、力学参数与通道风险。"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-BeJGNKkU.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_Bijv8RCu_exports as t };
